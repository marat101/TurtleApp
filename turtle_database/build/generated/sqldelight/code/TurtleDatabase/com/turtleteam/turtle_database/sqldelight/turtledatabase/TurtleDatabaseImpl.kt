...
private class TurtleDatabaseQueriesImpl(
  ...
  public override fun <T : Any> selectGroupScheduleByName(name: String, mapper: (days: String,
      name: String) -> T): Query<T> = SelectGroupScheduleByNameQuery(name) { cursor ->
    mapper(
      cursor.getString(0)!!,
      cursor.getString(1)!!
    )
  ...
  public override fun getSavedGroupsList(): Query<String> = Query(-1999650749, getSavedGroupsList,
      driver, "TurtleDatabase.sq", "getSavedGroupsList", "SELECT name FROM GroupsDaysList") {
      cursor ->
    cursor.getString(0)!!
  }

  public override fun <T : Any> selectTeacherScheduleByName(name: String, mapper: (days: String,
      name: String) -> T): Query<T> = SelectTeacherScheduleByNameQuery(name) { cursor ->
    mapper(
      cursor.getString(0)!!,
      cursor.getString(1)!!
    )
  ...
  public override fun getSavedTeachersList(): Query<String> = Query(-1121474432,
      getSavedTeachersList, driver, "TurtleDatabase.sq", "getSavedTeachersList",
      "SELECT name FROM TeachersDaysList") { cursor ->
    cursor.getString(0)!!
  }

  public override fun insertGroup(days: String, name: String): Unit {
    driver.execute(497066822, """
  ...
  public override fun insertTeacher(days: String, name: String): Unit {
    ...
    notifyQueries(-793156887, {database.turtleDatabaseQueries.getSavedTeachersList +
  ...
  private inner class SelectGroupScheduleByNameQuery<out T : Any>(
    ...
    public override fun execute(): SqlCursor = driver.executeQuery(1157402300,
  ...
  private inner class SelectTeacherScheduleByNameQuery<out T : Any>(
    ...
    public override fun execute(): SqlCursor = driver.executeQuery(1171845599,
